...
if TYPE_CHECKING:
    ...
    from .torch_utils import (Serializer, check_shared_disk, disable_safe_ddp_context_use_barrier, empty_cache,
                              ...
                              get_physical_device_count, get_torch_device, get_ui_device_info, init_process_group,
                              ipc_collect, is_torch_mlu_available, is_torch_rocm, nanstd, safe_ddp_context,
    ...
    _import_structure = {
        ...
        'torch_utils': [
            ...
            'get_ui_device_info', 'is_torch_mlu_available'
        ],
        'transformers_utils': [
